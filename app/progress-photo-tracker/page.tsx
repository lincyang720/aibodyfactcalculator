...
const page: LongTailPage = {
  ...
  steps: [
    { title: "Create a baseline", body: "Take your first photo in even lighting and save the numeric BodyLens result locally. This becomes your comparison point." },
  ...
  faq: [
    ...
    ["Does BodyLens store my progress photo history?", "The current free baseline stores only numeric results in your browser. The fuller photo history workflow is an interest-tested feature in development."],
  ],
  related: [
...
export const metadata: Metadata = buildPageMetadata({
  title: "Progress Photo Tracker for Physique Changes | BodyLens",
